...
// deviceMoved should define via threshold a state for resting or
// active/movement position. default threshold of 0.5 for device motion on X,Y,Z
/*
...
function deviceMoved(event)
{
    ...
    let device_motion = {
        "z_motion" :
            Math.round(windowWidth / 5 * Math.abs(radians(rotationZ) - PI)),
